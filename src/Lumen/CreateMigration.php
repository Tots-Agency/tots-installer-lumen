...
class CreateMigration extends AbstractOpenFile
{
    /**
     * Path del archivo a tener de base
     * @var string
     */
    protected $filePath = __DIR__ . '/../../data/lumen/create_migration.txt';
    /**
     * Path de la carpeta donde se va a guardar
     * @var string
     */
    protected $savePath = __DIR__ . '/../../../../../database/migrations/';
    /**
     * Nombre de la DB
     *
     * @var string
    ...
    ';
        ...
        file_put_contents($this->savePath . $dateName . '_create_' . $this->name . '_table.php', $this->file);
    }
